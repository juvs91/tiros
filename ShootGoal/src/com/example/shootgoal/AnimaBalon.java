...
public class AnimaBalon {
	   public List<Cuadro> cuadros;            //Lista de objetos Cuadro para los cuadros de la animaci������n
	    ...
	    ControladorTirador controlador;
    ...
    public synchronized boolean lanzaBalon(float tiempo,Point balonPos,Point diferencia){
    	
    	controlador.viewTirador.balonPos.x+=(int)(diferencia.x/10);
    	controlador.viewTirador.balonPos.y+=(int)(diferencia.y/10);
    		return true;
    }

...
import build.modelos.Jugadores;
...
public class ControladorNuevoJuego  extends Activity implements OnItemClickListener,OnClickListener  {
	...
	/**
	 * Si no encuentra amigos marca un error
	 */
	...
	/**
	 * Controlador para la busqueda de amigos 
	 * @param json
	 */
	...
	/**
	 * Controlador para manipualar los objetos json
	 * @param json
	 */
	...
	/**
	 * Creca una lista cn los juegos posibles
	...
	/**
	 * Selecciona lo que hara cuando se selccioene un jugador de la lista
	 */
	@Override
